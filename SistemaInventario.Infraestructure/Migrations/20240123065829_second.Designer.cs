...
namespace SistemaInventario.Infraestructure.Migrations
{
    ...
    [Migration("20240123065829_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaInventario.Domain.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaInventario.Domain.Entities.Transaccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaInventario.Domain.Entities.UserApp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SistemaInventario.Domain.Entities.UserApp", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaInventario.Domain.Entities.Producto", b =>
                {
                    b.HasOne("SistemaInventario.Domain.Entities.Categoria", "Categoria")
                        .WithMany("Productos")
